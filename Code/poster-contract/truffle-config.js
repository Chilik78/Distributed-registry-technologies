...
const mnemonic = "clog ranch captain want chalk giant galaxy recycle thunder tower setup method";
...
module.exports = {
  ...
  */
  ...
  networks: {
    ...
    polygon_mumbai: {
      provider: () => new HDWalletProvider({
        ...
        providerOrUrl: "https://polygon-amoy.blockpi.network/v1/rpc/public"
      }),
      network_id: 80002,
      confirmations: 2,
      timeoutBlocks: 200,
  ...
  api_keys: {
    polygonscan: 'R7AA3BFAAY88WCJ2QEF5XZXW3YD3BSM7IU'
  }
}
